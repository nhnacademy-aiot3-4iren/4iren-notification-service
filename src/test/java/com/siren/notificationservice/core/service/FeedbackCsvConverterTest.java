...
class FeedbackCsvConverterTest {
    ...
    void toCsvWritesFeedbackScoreAndWeatherDiffRows() {
        LocalDateTime experiencedAt = LocalDateTime.parse("2026-07-20T14:00:00");
        ...
        assertThat(csv)
                .contains("1042,7,2026-07-20T14:00:00,FEEDBACK_TEMPERATURE,1")
                .contains("1042,7,2026-07-20T14:00:00,OUTSIDE_TEMPERATURE,28.4")
                .contains("1042,7,2026-07-20T14:00:00,INDOOR_OUTDOOR_TEMP_DIFF,-4.2");
    }
    ...
    void toCsvLeavesReferenceAtBlankWhenDelayedWithoutExperiencedTime() {
        FeedbackLog log = FeedbackLog.builder()
                ...
                .createdAt(LocalDateTime.now()).delayed(true).experiencedAt(null).userId(1L).build();
    ...
    void toCsvSkipsWeatherRowsWhenNoOutsideWeather() {
        FeedbackLog log = FeedbackLog.builder()
                ...
                .createdAt(LocalDateTime.now()).userId(1L).delayed(false).build();
        FeedbackScore score = FeedbackScore.builder()
