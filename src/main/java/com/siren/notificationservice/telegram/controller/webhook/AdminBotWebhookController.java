...
import com.siren.notificationservice.telegram.controller.webhook.doc.AdminBotWebhookControllerDoc;
...
public class AdminBotWebhookController implements AdminBotWebhookControllerDoc {
    ...
    public ResponseEntity<Void> webhookAdmin(@RequestBody Update update) {
        ...
        rabbitTemplate.convertAndSend(inbound.getExchange(), inbound.getRoutingKey(), new TelegramInboundEvent(BotType.ADMIN_BOT, update));
